...
class EstadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estado" do
    assert_difference("Estado.count") do
      post estados_url, params: { estado: { nome: @estado.nome, pais_id: @estado.pais_id, sigla: @estado.sigla } }
    end
  ...
  test "should update estado" do
    patch estado_url(@estado), params: { estado: { nome: @estado.nome, pais_id: @estado.pais_id, sigla: @estado.sigla } }
