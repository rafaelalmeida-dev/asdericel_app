...
class MunicipiosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create municipio" do
    assert_difference("Municipio.count") do
      post municipios_url, params: { municipio: { estado_id: @municipio.estado_id, nome: @municipio.nome } }
    end
  ...
  test "should update municipio" do
    patch municipio_url(@municipio), params: { municipio: { estado_id: @municipio.estado_id, nome: @municipio.nome } }
