...
class NoticiasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create noticia" do
    assert_difference("Noticia.count") do
      post noticia_url, params: { noticia: { categoria: @noticia.categoria, conteudo: @noticia.conteudo, data_publicacao: @noticia.data_publicacao, destaque: @noticia.destaque, imagem: @noticia.imagem, titulo: @noticia.titulo } }
    end
  ...
  test "should update noticia" do
    patch noticia_url(@noticia), params: { noticia: { categoria: @noticia.categoria, conteudo: @noticia.conteudo, data_publicacao: @noticia.data_publicacao, destaque: @noticia.destaque, imagem: @noticia.imagem, titulo: @noticia.titulo } }
