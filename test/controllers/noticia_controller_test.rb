...
class NoticiaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create noticium" do
    assert_difference("Noticium.count") do
      post noticia_url, params: { noticium: { categoria: @noticium.categoria, conteudo: @noticium.conteudo, data_publicacao: @noticium.data_publicacao, destaque: @noticium.destaque, imagem: @noticium.imagem, titulo: @noticium.titulo } }
    end
  ...
  test "should update noticium" do
    patch noticium_url(@noticium), params: { noticium: { categoria: @noticium.categoria, conteudo: @noticium.conteudo, data_publicacao: @noticium.data_publicacao, destaque: @noticium.destaque, imagem: @noticium.imagem, titulo: @noticium.titulo } }
