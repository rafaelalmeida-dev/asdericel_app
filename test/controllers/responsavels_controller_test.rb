...
class ResponsavelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create responsavel" do
    assert_difference("Responsavel.count") do
      post responsavels_url, params: { responsavel: { cpf: @responsavel.cpf, email: @responsavel.email, nome: @responsavel.nome, parentesco_id: @responsavel.parentesco_id, rg: @responsavel.rg, telefone: @responsavel.telefone } }
    end
