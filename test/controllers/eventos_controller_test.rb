...
class EventosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evento" do
    assert_difference("Evento.count") do
      post eventos_url, params: { evento: { datafim: @evento.datafim, datainicio: @evento.datainicio, edicacao: @evento.edicacao, local: @evento.local, nome: @evento.nome, promotor: @evento.promotor } }
    end
  ...
  test "should update evento" do
    patch evento_url(@evento), params: { evento: { datafim: @evento.datafim, datainicio: @evento.datainicio, edicacao: @evento.edicacao, local: @evento.local, nome: @evento.nome, promotor: @evento.promotor } }
