...
class EventosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evento" do
    assert_difference("Evento.count") do
      post eventos_url, params: { evento: { categoria: @evento.categoria, edicao: @evento.edicao, estado: @evento.estado, municipio: @evento.municipio, nome: @evento.nome, pais: @evento.pais } }
    end
  ...
  test "should update evento" do
    patch evento_url(@evento), params: { evento: { categoria: @evento.categoria, edicao: @evento.edicao, estado: @evento.estado, municipio: @evento.municipio, nome: @evento.nome, pais: @evento.pais } }
